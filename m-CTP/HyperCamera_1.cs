...
namespace m_CTP
{
    ...
    //public enum psVixDeviceParam
    //{
    //    iProgramMode = 0,        //软件运行模式
    //    iWidth = 0,              //图像宽像素
    //    iHeight = 0,             //图像高像素
    //    iDepth = 0,              //图像像素位深
    //    iSize = 0,               //图像缓冲区大小
    //    pImg = 0,                //图像缓冲区地址byte[]
    //    pScanImg = 0,            //推扫采集图像缓冲区地址byte[]
    //    iTimeId = 0,             //曝光时间
    //    iGainId = 0,             //增益
    //}
    ...
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
    public struct psVixDeviceParam
    {
    ...
    /* [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10000)]
        public IntPtr pImg;                // 相机图像缓冲区
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10000)]
        public IntPtr pScanImg;                    // 推扫图像缓冲区
     * 
     */
    public class HyperCamera_1
    {
        ...
        public static extern int Vix_Init (ref psVixDeviceParam psVixDeviceParam, ref psVixWbParam psVixWbParam, DllcallBack callbackfunc,  string datapath, IntPtr sVixID);//ef psVixDeviceParam psVixDeviceParam, 
        ...
        */
        ...
        public static extern void Vix_TakeWbData(psVixWbParam psVixWbParam);

        /*清除参考板。清除后不允许发起类型为反射率的光谱采集。
         返回值：psVixWbParam（参考板采集参数，见公共数据结构）
        */
        [DllImport("VixLib.dll", EntryPoint = "Vix_ClearWbData", CallingConvention = CallingConvention.Cdecl)]
        public static extern void Vix_ClearWbData(psVixWbParam psVixWbParam);
      ...
      像后正新的专用内存空间完成图像操作。
        */
        ...
        public psVixDeviceParam psVixDevice1 = new psVixDeviceParam();
        public psVixWbParam psVixWbParam1 = new psVixWbParam();
